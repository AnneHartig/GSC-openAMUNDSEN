...
config = oa.read_config('C:/Users/subha/Documents/Anne/openamundsen-examples-main/openamundsen-examples-main/rofental/rofental.yml')

# Calculate openness-based snow redistribution factor field based on the
# parameters by Hanzer et al. (2016)
srf_file = Path('C:/Users/subha/Documents/Anne/openamundsen-examples-main/openamundsen-examples-main/rofental/grids')
